...
export const RouteQueryOutputSchema = z.object({
  ...
  graph_snapshot_age_ms: z.number().optional().describe('Age of the graph data snapshot in milliseconds'),
  model_version: z.string().optional().describe('Version of the ML model used for predictions'),
