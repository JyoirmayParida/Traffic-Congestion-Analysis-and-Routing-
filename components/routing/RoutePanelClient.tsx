              ...
              {currentResult.optimal_route.route.map((jId, idx) => {
                ...
                return (
                  <div key={jId} className="relative">
                    <div className="absolute -left-[21px] top-1 w-3 h-3 rounded-full bg-white border-2 border-indigo-600" />
                    <div className="flex justify-between items-start">
                      <div>
                        <div className="text-sm font-medium text-slate-900">{j?.name || jId}</div>
                        {j && (
                          <div className="mt-1">
                    ...
                    {/* SECTION 3 — ML INSIGHT ROW (mocked for now) */}
                    {segment && (
                      <div className="mt-3 mb-1 p-2 bg-slate-50 rounded border border-slate-100">
                        ...
                        <div className="space-y-1">
                          <div className="flex items-center text-xs">
                            <span className="w-16 truncate text-slate-600">Queue</span>
                            <div className="flex-1 h-1.5 bg-slate-200 rounded-full mx-2 overflow-hidden">
                              <div className="h-full bg-rose-400 w-[70%]" />
                            </div>
                            <span className="text-slate-400 text-[10px]">+12s</span>
                          </div>
                          <div className="flex items-center text-xs">
                            <span className="w-16 truncate text-slate-600">Density</span>
                            <div className="flex-1 h-1.5 bg-slate-200 rounded-full mx-2 overflow-hidden">
                              <div className="h-full bg-amber-400 w-[40%]" />
                            </div>
                            <span className="text-slate-400 text-[10px]">+5s</span>
                          </div>
                        </div>
                      </div>
                    )}
